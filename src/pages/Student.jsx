              ...
              <Table sx={{ minWidth: 700 }} size="small">
                <TableHead sx={{ bgcolor: 'background.default' }}>
                  <TableRow>
                    ...
                    <TableCell align="center" sx={{ fontWeight: 600, color: 'text.secondary', borderBottom: '1px solid', borderColor: 'divider', px: 1 }}>Tug'ilgan</TableCell>
                    ...
                    <TableRow key={index} hover sx={{ '& td': { borderBottom: '1px solid', borderColor: 'divider', py: 1, px: 1 } }}>
                      ...
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                          ...
                          <Typography sx={{ fontWeight: 500, color: 'text.primary', fontSize: '14px' }}>{studentItem.full_name}</Typography>
                        </Box>
                      </TableCell>
                      ...
                      <TableCell align="center" sx={{ color: 'text.secondary', whiteSpace: 'nowrap', fontSize: '14px' }}>{studentItem.phone || '-'}</TableCell>
                      <TableCell align="center" sx={{ color: 'text.secondary', fontSize: '14px', wordBreak: 'break-word', maxWidth: 180 }}>{studentItem.email || '-'}</TableCell>
                      <TableCell align="center" sx={{ color: 'text.secondary', fontSize: '14px', whiteSpace: 'nowrap' }}>{studentItem.birth_date ? studentItem.birth_date.split('T')[0] : '-'}</TableCell>
                      <TableCell align="center" sx={{ color: 'text.secondary', fontSize: '14px', maxWidth: 120 }}>{studentItem.address || '-'}</TableCell>
                      <TableCell align="center" sx={{ color: 'text.secondary', whiteSpace: 'nowrap', fontSize: '14px' }}>{studentItem.created_at?.split('T')[0] || '-'}</TableCell>
        ...
        <Drawer anchor="right" open={isDrawerOpen} onClose={() => { setIsDrawerOpen(false); resetForm(); }}
          ...
          <Box sx={{ p: 3, flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            ...
            <Box>
              ...
              <Box sx={{ border: '1px solid', borderColor: 'divider', borderRadius: '8px', p: createStudent.groups.length > 0 ? 1.5 : 0, minHeight: '42px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <Button variant={createStudent.groups.length > 0 ? 'text' : 'outlined'} color="primary"
                  ...
                  sx={{ width: createStudent.groups.length > 0 ? 'auto' : '100%', alignSelf: 'flex-start', justifyContent: 'flex-start', borderColor: 'divider', p: createStudent.groups.length > 0 ? 0 : 1.5, minWidth: 0, fontWeight: 500, '&:hover': { borderColor: '#7C3AED', bgcolor: createStudent.groups.length > 0 ? 'transparent' : 'action.hover' } }}>
